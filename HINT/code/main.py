...
def test(cfg):
    from stillfast.datasets.ego4d_sta_still_video import Ego4dShortTermAnticipationStillVideo
    from tqdm import tqdm
    from stillfast.datasets.loader import  construct_loader
...
def main(cfg):
    ...
    print("frozeing the model backnone!!!")
